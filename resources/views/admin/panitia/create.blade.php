...
<div class="px-4 py-8 lg:px-8">
    <div class="max-w-3xl">
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-slate-900">Tambah Panitia</h1>
            <p class="mt-1 text-slate-600">Buat akun panitia baru.</p>
        </div>
        ...
        <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-8">
            <form action="{{ route('admin.panitia.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="jabatan" value="{{ old('jabatan') }}" class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-200 focus:border-blue-400" required>
