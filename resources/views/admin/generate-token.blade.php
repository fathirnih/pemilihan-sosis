        ...
        <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-8">
            ...
            @if (!$periode)
                <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                    <p class="text-yellow-800">⚠️ Tidak ada periode pemilihan yang aktif. Silahkan buat periode terlebih dahulu.</p>
                </div>
            @else
                    ...
                    <div>
                        ...
                        <div class="space-y-3">
                            <label class="flex items-center">
                                <input type="radio" name="tipe_pemilih" value="siswa" checked class="w-4 h-4 text-blue-600">
                                <span class="ml-3 text-slate-700">🎓 Siswa</span>
                            </label>
                            <label class="flex items-center">
                                <input type="radio" name="tipe_pemilih" value="guru" class="w-4 h-4 text-blue-600">
